...
data = {
    ...
    description: `Cualquier duda sobre los comandos puedes escribirle a Rich#3505
    ...
    fieldValue2: '-poto  -hentai  -tetica' ,
    fieldName3: 'Comandos Anime' ,
    fieldValue3: '-buscaranime  -buscarmanga'
} 
