...
function rollBall(args){
    const ball = [
        ...
        'Soy yo literal',
        'SAPEEEEEEEE',
        'No soy yo la concha de tu madre.',
        'Sin tiempo para morir solo en cines.',
        'https://paypal.me/otpstrafe, Que lindo link.',
        'Pasen porno :enojao:',
        'Pueden usar -info para irse a la concha de su madre',
